...
async function loadPost() {
  ...
  try {
    ...
    const heroImg = post.imageUrl
      ? `<div class="post-hero__media"><img src="${escapeHtml(post.imageUrl)}" alt="" width="1200" height="675" loading="eager" onerror="this.onerror=null; this.className='post-hero__media--gradient'; this.removeAttribute('src');" /></div>`
